...
using AbakonXVWPF.Views.Controls.Standard;
...
namespace AbakonXVWPF.Views.Controls.Standard
{
    class ClosableTab : TabItem
    {
        ...
        {
            ((CloseableHeader)this.Header).button_close.Margin = new Thickness(((CloseableHeader)this.Header).label_TabTitle.ActualWidth + 5, 0, 0, 0);
        }
