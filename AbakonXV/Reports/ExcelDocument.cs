...
namespace AbakonXVWPF.Reports
{
    public class ExcelDocument
    {
        ...
        #region Get info from Excel document
        /* Przykład kopiowania obszarów
        ...
        public static List<string> GetSheetsNames(string fileName)
        {
            ...
            try
            {
                Excel._Application _xlApp = new Excel.Application();
                Excel.Workbook wbSource = _xlApp.Workbooks.Open(fileName, misValue, misValue, misValue, misValue, misValue, misValue, misValue,
                                                                     misValue, misValue, misValue, misValue, misValue, misValue, misValue);
                foreach (Excel.Worksheet item in wbSource.Sheets)
                {
                    result.Add(item.Name);
                }

                _xlApp.ActiveWorkbook.Close(false);
            ...
            #region OpenXml nie pozwala czytać pliku jeśli już jest otwarty
            //try
            //{
        ...
        public static void CopyRangeToClipboard(string file, string sheetName, string range)
        {


            Excel._Application _xlApp = new Excel.Application();
            Excel.Workbook wbSource = _xlApp.Workbooks.Open(file, misValue, misValue, misValue, misValue, misValue, misValue, misValue,
                                                                 misValue, misValue, misValue, misValue, misValue, misValue, misValue);
            Excel.Worksheet WorksheetToCopy = wbSource.Sheets[sheetName];
            string[] ranges = range.Split(':');
            WorksheetToCopy.Range[ranges[0], ranges[1]].Copy(Missing.Value);
            //  WorksheetSource.UsedRange.Copy(Missing.Value);

            _xlApp.ActiveWorkbook.Close(false);


            releaseObject(WorksheetToCopy);
            releaseObject(wbSource);
            releaseObject(_xlApp);
        }
        ...
        private static void releaseObject(object obj)
        {
            ...
            {
                obj = null;
                MessageBox.Show("Wystąpił błąd podczas zwalniania obiektu COM: \n " + ex.ToString());
            }
            finally
            {
                GC.Collect();
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            Sheet sheet1 = new Sheet() { Name = "2015", SheetId = (UInt32Value)1U, Id = "rId1" };
        ...
        private void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            CellStyle cellStyle1 = new CellStyle() { Name = "Normalny", FormatId = (UInt32Value)0U, BuiltinId = (UInt32Value)0U };
        ...
        private void GenerateThemePart1Content(ThemePart themePart1)
        {
            ...
            A.FontScheme fontScheme4 = new A.FontScheme() { Name = "Pakiet Office" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2015-02-03T11:01:31Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
        }

        #region Binary Data
        private string spreadsheetPrinterSettingsPart1Data = "";
