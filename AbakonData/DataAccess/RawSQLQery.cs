...
{
    // From http://stackoverflow.com/questions/26749429/anonymous-type-result-from-sql-query-execution-entity-framework
    // Based on http://www.codeproject.com/Articles/206416/Use-dynamic-type-in-Entity-Framework-SqlQuery

    public static class RawSQLQery
    {
        public static System.Collections.IEnumerable DynamicSqlQuery(this Database database, string sql, string myDynamicType, params object[] parameters)
        {
            ...
            using (System.Data.IDbCommand command = database.Connection.CreateCommand())
            {
                try
                {
                    ...
                    using (System.Data.IDataReader reader = command.ExecuteReader(System.Data.CommandBehavior.SchemaOnly))
                    {
